...
export const es: Language = {
  ...
  categories_bulk_delete: (n: number) => `Eliminar (${n})`,
  categories_bulk_delete_confirm_title: (n: number) => `¿Eliminar ${n} categoría${n === 1 ? '' : 's'}?`,
  categories_bulk_delete_confirm_message_tx: (n: number, total: number) =>
    n === 1
      ? `1 de las ${total} categorías seleccionadas tiene transacciones. Sus transacciones se eliminarán a menos que las muevas a otra categoría primero. Las categorías sin transacciones se eliminarán directamente.`
      : `${n} de las ${total} categorías seleccionadas tienen transacciones. Sus transacciones se eliminarán a menos que las muevas a otra categoría primero. Las categorías sin transacciones se eliminarán directamente.`,
  categories_bulk_delete_confirm_message_empty: 'Las categorías seleccionadas se eliminarán permanentemente.',
  categories_bulk_delete_confirm_delete: 'Eliminar permanentemente',
  categories_bulk_delete_confirm_move: 'Mover transacciones primero',
  categories_bulk_delete_min_one: 'No puedes eliminar todas las categorías de un tipo. Debe quedar al menos una.',
  categories_bulk_move_title: 'Mover transacciones',
  categories_bulk_move_confirm: 'Mover y eliminar',
  categories_bulk_move_delete_option: 'Eliminar transacciones',
  categories_bulk_move_choose: 'Elegir…',
  categories_bulk_move_note: 'Las categorías sin transacciones se eliminarán.',
  categories_bulk_move_transactions: (n: number) => `${n} transacción${n === 1 ? '' : 'es'}`,
  ...
  accounts_bulk_delete_confirm_title: (n: number) => `¿Eliminar ${n} cuenta${n === 1 ? '' : 's'}?`,
  accounts_bulk_delete_confirm_message: 'Las transacciones vinculadas a las cuentas seleccionadas también serán eliminadas.',
  accounts_bulk_delete_min_one: 'Necesitas al menos una cuenta. No se pueden eliminar todas.',
  ...
  currency_ils: 'Séquel israelí',
  currency_aed: 'Dírham de EAU',
  currency_sar: 'Riyal saudí',
  ...
  a11y_exit_select_mode: 'Salir del modo selección',
  ...
  a11y_cancel: 'Cancelar',
  a11y_menu: 'Abrir menú',
};
