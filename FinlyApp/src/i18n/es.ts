...
export const es: Language = {
  ...
  settings_delete_data_confirm_message: 'Esto restablecerá la app al estado de fábrica. Todas las cuentas, categorías, etiquetas, transacciones y configuración se eliminarán. Esto no se puede deshacer.',
