...
export const ca: Language = {
  ...
  settings_export_data: 'Exportar dades',
  settings_import_data: 'Importar dades',
  settings_export_success_title: 'Exportació completada',
  ...
  settings_import_success_message: 'Les teves dades s\'han restaurat des de la còpia de seguretat.',
  settings_import_error_title: 'Error en importar',
  ...
  settings_delete_all_data_description: 'Elimina tots els comptes, categories, etiquetes i transaccions. La teva configuració es conserva.',
  ...
  settings_delete_data_confirm_message: 'Tots els comptes, categories, etiquetes i transaccions s\'eliminaran permanentment. La teva configuració (idioma, tema, moneda i valors per defecte) es conserva. Això no es pot desfer.',
  ...
  settings_factory_reset: 'Restablir estat de fàbrica',
  settings_factory_reset_description: 'Elimina-ho tot i restableix els valors per defecte: idioma, tema, moneda i configuració.',
  settings_factory_reset_confirm_title: 'Restablir l\'estat de fàbrica?',
  settings_factory_reset_confirm_message: 'Això restablirà l\'app a l\'estat de fàbrica. Tots els comptes, categories, etiquetes, transaccions i configuració s\'eliminaran i tornaran als seus valors per defecte. Això no es pot desfer.',
  ...
  create_cat_error_limit: (max: number) => `S'ha assolit el màxim de ${max} categories per tipus`,
  categories_counter: (current: number, max: number) => `${current} de ${max} categories`,
  categories_bulk_delete: (n: number) => `Elimina (${n})`,
  categories_bulk_delete_confirm_title: (n: number) => `Vols eliminar ${n} categoria${n === 1 ? '' : 's'}?`,
  categories_bulk_delete_confirm_message_tx: (n: number, total: number) =>
    n === 1
      ? `1 de les ${total} categories seleccionades té transaccions. Les seves transaccions s'eliminaran tret que les moguis a una altra categoria primer. Les categories sense transaccions s'eliminaran directament.`
      : `${n} de les ${total} categories seleccionades tenen transaccions. Les seves transaccions s'eliminaran tret que les moguis a una altra categoria primer. Les categories sense transaccions s'eliminaran directament.`,
  categories_bulk_delete_confirm_message_empty: 'Les categories seleccionades s\'eliminaran permanentment.',
  categories_bulk_delete_confirm_delete: 'Elimina permanentment',
  categories_bulk_delete_confirm_move: 'Mou les transaccions primer',
  categories_bulk_delete_min_one: 'No pots eliminar totes les categories d\'un tipus. N\'ha de quedar com a mínim una.',
  categories_bulk_move_title: 'Moure transaccions',
  categories_bulk_move_confirm: 'Moure i eliminar',
  categories_bulk_move_delete_option: 'Eliminar transaccions',
  categories_bulk_move_choose: 'Tria…',
  categories_bulk_move_note: 'Les categories sense transaccions s\'eliminaran.',
  categories_bulk_move_transactions: (n: number) => `${n} transacció${n === 1 ? '' : 'ns'}`,
  ...
  accounts_bulk_delete_confirm_title: (n: number) => `Eliminar ${n} compte${n === 1 ? '' : 's'}?`,
  accounts_bulk_delete_confirm_message: 'Les transaccions vinculades als comptes seleccionats també seran eliminades.',
  accounts_bulk_delete_min_one: 'Necessites almenys un compte. No es poden eliminar tots.',
  ...
  // Currencies
  currency_euro: 'Euro',
  currency_usd: 'Dòlar dels EUA',
  currency_gbp: 'Lliura esterlina',
  currency_jpy: 'Ien japonès',
  currency_chf: 'Franc suís',
  currency_cad: 'Dòlar canadenc',
  currency_aud: 'Dòlar australià',
  currency_nzd: 'Dòlar neozelandès',
  currency_sek: 'Corona sueca',
  currency_nok: 'Corona noruega',
  currency_dkk: 'Corona danesa',
  currency_pln: 'Zloty polonès',
  currency_czk: 'Corona txeca',
  currency_huf: 'Forint hongarès',
  currency_ron: 'Leu romanès',
  currency_try: 'Lira turca',
  currency_brl: 'Real brasiler',
  currency_inr: 'Rupia índia',
  currency_krw: 'Won sud-coreà',
  currency_cny: 'Iuan xinès',
  currency_thb: 'Baht tailandès',
  currency_sgd: 'Dòlar de Singapur',
  currency_myr: 'Ringgit malai',
  currency_php: 'Peso filipí',
  currency_idr: 'Rupia indonèsia',
  currency_vnd: 'Dong vietnamita',
  currency_zar: 'Rand sud-africà',
  currency_ils: 'Xéquel israelià',
  currency_aed: 'Díram dels EAU',
  ...
  tags_counter: (current: number, max: number) => `${current} de ${max} etiquetes`,
  ...
  create_tag_error_limit: (max: number) => `S'ha assolit el màxim de ${max} etiquetes`,
  ...
  comments_counter: (n: number) => `${n} comentari${n === 1 ? '' : 's'}`,
